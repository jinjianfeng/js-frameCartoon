...
FrameCartoon.prototype = {
  ...
  start: function() {
    ...
    var time = Math.floor(1000/self.frameNum);
    ...
    var move = function() {
      if (self.direction == 'vertical') {
        ...
        self.el.style.backgroundPosition = '0 '+ distance +'px';
      }else{
        distance -= self.width;
        self.el.style.backgroundPosition = distance +'px 0';
      }
      step++;
      if (step >= self.frameNum) {
        distance = 0;
        step = 0;
        count++;
      }
